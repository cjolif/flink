 ...
 * {@link DocWriteRequest DocWriteRequests} should be handled, e.g. dropping them, reprocessing
 * malformed documents, or
...
public interface DocWriteRequestFailureHandler extends Serializable {
	 ...
	 *
	 * @param docWriteRequest the {@link DocWriteRequest} that failed due to the failure
	 ...
	 */
	void onFailure(DocWriteRequest docWriteRequest, Throwable failure, int restStatusCode, RequestIndexer indexer) throws Throwable;
